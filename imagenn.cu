...
int main()
{
    ...
    LayerDense ld1(n_inputs, n_neurons, false, num_samples, true);
    LayerDense ld2(n_neurons, n_neurons, false, num_samples, true);
    ...
    for (size_t i = 0; i < num_iters; i++)
    {
        ...
        ld1.forward_relu(trainimages);
        ld2.forward_relu(ld1.output);
        ld3.forward(ld2.output);
        ...
        ld2.backwardw_relu(ld3.dinputs);
        ld1.backwardw_relu(ld2.dinputs);
